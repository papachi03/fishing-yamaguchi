...
> - ⚠️ 未確認：`Prd-FpgvXmk` のYouTube上のタイトルが「堤防釣りで春のコウイカはどこまで釣れる？」で、
...
- **★の付いた上位5本は固定コメントも付ける**（文面は `PROMO_YOUTUBE.md` の §3。固定コメントのURLは `utm_medium=comment&utm_content=動画ID` に変える）
