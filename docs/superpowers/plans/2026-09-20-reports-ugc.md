...
// Discordで知らせるときにメンションする相手（ダディのDiscordユーザーID。秘密の値ではない）
export const NOTIFY_MENTION_USER_ID = '427260359473364992';
```
...
Cloudflareは **Hoodhomies@gmail.com's Account** で作業します。所要30分ほど。費用は0円です。
